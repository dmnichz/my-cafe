...
@Component
public class CafeTablesNumberSpecification implements SpecificationProvider<Cafe> {
    ...
    private static final String FILTER_KEY = "tables";
    private static final String FIELD_NAME = "tablesNumber";
    @Override
